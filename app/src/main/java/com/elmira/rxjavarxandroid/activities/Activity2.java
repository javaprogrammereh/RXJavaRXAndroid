...
import com.elmira.rxjavarxandroid.adapter.RecyclerAdapter;
import com.elmira.rxjavarxandroid.model.Comment;
import com.elmira.rxjavarxandroid.model.Post;
import com.elmira.rxjavarxandroid.webservice.ServiceGenerator;
...
public class Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getPostsObservable()
                ...
                .concatMap(new Function<Post, ObservableSource<Post>>() {    //flatMap
                    @Override
    ...
    private void updatePost(final Post p){
        Observable
                ...
                .subscribe(new Observer<Post>() {
                    ...
                    @Override
                    public void onNext(Post post) {
                        Log.d(TAG, "onNext: updating post::get id:: " + post.getId() + ", thread:::: " + Thread.currentThread().getName());
                        adapter.updatePost(post);
                    }

                    @Override
                    public void onError(Throwable e) {
                        Log.e(TAG, "onError::updatePost:: ", e);
                    }

                    @Override
                    public void onComplete() {
                        Log.e(TAG, "onComplete::updatePost:: ");
                    }
                });
    }
